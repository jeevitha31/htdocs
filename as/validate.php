...
<html>
	...
	$(document).ready(function(){
		 if(document.getElementById("save").value == 1){
			swal("Done!", "You informations are saved!", "success"). then(function(result){
...
$tmpname =  addslashes(file_get_contents($_FILES["upload"]["tmp_name"]));
