...
<html>
	<head>
        ...
        fields: {
            fname: {
				...
				regexp: {
				regexp: /^[a-z\s]+$/i,
				message: 'Albhabets are allowed.Invalid Format'
         }
			 ...
			 mob: {
				...
				regexp: {
				regexp: /^[0-9]+$/i,
				message: 'Only allow numbers and Invalid Format'
         }
			 ...
			 dob: {
                validators: {
                    notEmpty: {
                        message: 'Dirth of Birth is required and cannot be empty'
                    }
                }
            },
			upload: {
			...
			ug: {
                validators: {
                    notEmpty: {
                        message: 'Under graduate is required and cannot be empty'
                    },
				regexp: {
				regexp: /^[a-z\s]+$/i,
				message: 'Only allow alphabets.Invalid Format'
         }
			...
			yop10: {
				...
				regexp: {
				regexp: /^[0-9]+$/i,
				message: 'Only allow numbers.Invalid Format'
         }
			...
			ugcollege: {
                validators: {
                    notEmpty: {
                        message: 'UG collegename is required and cannot be empty'
                    },
				regexp: {
				regexp: /^[a-z\s]+$/i,
			...
			pincode: {
                validators: {
					...
					regexp: {
					regexp: /^[0-9]+$/i,
					message: 'Allow only numbers.Invalid Format'
         }
			...
			birthp: {
                validators: {
                    notEmpty: {
                        message: 'Birth place is required and cannot be empty'
                    }
			...
			nativep: {
                validators: {
                    notEmpty: {
                        message: 'Native place is required and cannot be empty'
                    }
			...
			sno1: {
                validators: {
                    notEmpty: {
                        message: 'Sno: is required and cannot be empty'
                    }
			...
			name1: {
                validators: {
                    notEmpty: {
                        message: 'Family member name is required and cannot be empty'
                    }
			...
			dob1: {
                validators: {
                    notEmpty: {
                        message: 'Family member dob is required and cannot be empty'
                    }
			...
			relation1: {
                validators: {
                    notEmpty: {
                        message: 'Family member relationship is required and cannot be empty'
                    }
			...
			occup1: {
                validators: {
                    notEmpty: {
                        message: 'Family member occupation is required and cannot be empty'
                    }
			...
			add1: {
                validators: {
                    notEmpty: {
                        message: 'Family member address is required and cannot be empty'
                    }
			...
			cont1: {
                validators: {
                    notEmpty: {
                        message: 'Family member contact number is required and cannot be empty'
                    },
				regexp: {
				regexp: /^[0-9]+$/i,
				message: 'Allow only numbers.Invalid Format'
	...
	<body>
		...
		<center><h1>Asminds Employee Registration</h1></center>
		...
		<div class = "container">
			<form action="validate.php" id="contactForm" method="POST" data-toggle="validator" role="form" class=" form-horizontal" enctype="multipart/form-data">
				...
				<br/><br/>
				<div class ="row">
					<input type ="submit" value="SUBMIT" onsubmit = "successalert()" class="col-md-12 btn btn-primary">
				</div>
				<br/><br/>
				<div class="row">
					<div class="col-md-12">
